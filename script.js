...
const renderizarPergunta = () => {
    ...
    const titulo = document.getElementById('enunciado-pergunta');
    const alternativas = document.getElementById('container-opcoes');

    titulo.textContent = `Pergunta ${perguntaAtual + 1}: ${pergunta.enunciado}`;
...
const finalizarJogo = () => {
    ...
    document.getElementById('nome-personagem').textContent = vencedor.nome;
    document.getElementById('descricao-personagem').textContent = vencedor.descricao;
    document.getElementById('foto-personagem').src = vencedor.imagem;
...
document.getElementById('botaoinciar').addEventListener('click', iniciarJogo);
document.getElementById('botaoproximo').addEventListener('click', proximaPergunta);
